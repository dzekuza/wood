...
export type SearchSuggestionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
...
export type RelatedArticleFragment = Pick<
...
export type JournalArticleFragment = Pick<
  StorefrontAPI.Article,
  'id' | 'handle' | 'title' | 'publishedAt'
> & {
  image?: StorefrontAPI.Maybe<
...
export type MoneyPopularProductLandingOakFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;
...
export type HeroShowcaseCollectionLandingOakFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle'
> & {
  image?: StorefrontAPI.Maybe<
...
export type HeroShowcaseLandingOakQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type HeroShowcaseLandingOakQuery = {
...
export type PopularProductsLandingOakQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  query?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['String']['input']>;
}>;
...
> & {
  ...
  media: {
    nodes: Array<
      | {__typename: 'ExternalVideo' | 'Video'}
  ...
  metafield?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  sliderOptions?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      metafield?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      sliderOptions?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      addonProducts?: StorefrontAPI.Maybe<{
        references?: StorefrontAPI.Maybe<{
