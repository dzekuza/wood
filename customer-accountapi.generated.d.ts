...
export type CustomerEmailForAdminCheckQueryVariables =
  CustomerAccountAPI.Exact<{[key: string]: never}>;

export type CustomerEmailForAdminCheckQuery = {
  customer: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CustomerEmailForAdminCheck {\n    customer {\n      emailAddress {\n        emailAddress\n      }\n    }\n  }\n': {
    return: CustomerEmailForAdminCheckQuery;
    variables: CustomerEmailForAdminCheckQueryVariables;
  };
